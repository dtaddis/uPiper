@echo off
echo ============================================
echo Building Full OpenJTalk WASM with CMake
echo ============================================
...
docker build -f Dockerfile.cmake -t openjtalk-cmake-builder .
if %ERRORLEVEL% neq 0 (
...
docker run --rm -v "%cd%\output:/output" openjtalk-cmake-builder
if %ERRORLEVEL% neq 0 (
